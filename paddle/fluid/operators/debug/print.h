...
inline void PrintVariableLod(const framework::LoDTensor& in_tensor,
...
inline void PrintVariableLod(const framework::Variable* in_var_ptr,
                             const std::string& var_name,
                             const std::string& message,
                             const bool print_tensor_name,
                             const bool print_tensor_type,
...
inline void PrintVariableLod(const framework::Scope& scope,
                             const std::string& var_name,
                             const std::string& message,
                             const bool print_tensor_name,
                             const bool print_tensor_type,
